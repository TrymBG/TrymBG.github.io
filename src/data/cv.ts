  ...
  experience: [
    {
      ...
      location: "Bergen, Norway",
      description: ["Working on Superpods"],
    },
    {
      title: "Research Assistant",
      ...
      location: "Bergen, Norway",
      description: ["VR development and research"],
    },
    {
      ...
      location: "Bergen, Norway",
      description: ["Simple maintenance at school premises"],
    },
    {
    ...
    },
    {
      ...
      description: [
        "Maintained and operated weapon systems on board KV Nordkapp",
        "Side roles: Smoke diver, flight deck crew, and lookout",
      ],
    },
  ],
  education: [
